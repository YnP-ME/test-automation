...
class LoginPage(BasePage):
    ...
    def __init__(self, page, base_url):
        ...
        self.admin_panel_button = page.locator("a[href='/profile']")
        ...
        self.admin_profile_link = page.locator("a[href='/profile']")
        self.staffing_platform_button = page.get_by_text("Staffing Platform", exact=True)
        self.dochub_button = page.get_by_text("Doc Hub", exact=True)
        self.people_button = page.get_by_text("People", exact=True)
        self.performance_review_panel_button = page.get_by_text("My Performance Review", exact=True)
